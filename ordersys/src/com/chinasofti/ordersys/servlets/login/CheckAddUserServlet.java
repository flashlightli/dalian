...
/**
 * Servlet implementation class CheckAddUserServlet
 */
@WebServlet("/CheckAddUserServlet")
public class CheckAddUserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (new UserDao().testadduser(userAccount)) {
			String responseTxt = "NO";
			response.getWriter().print(responseTxt);
		} else {
			String responseTxt = "OK";
			response.getWriter().print(responseTxt);
		}
	}
