	...
	function getDishesList(page) {
		...
		$.ajax({
			...
			success: function (result) {
				...
				link.href = "javascript:getDishesList(" + maxPage + ")";
				...
				table.innerHTML = "";
				for ( var i = 0; i < result.dishesCount; i++) {
					var dish = result.dishes[i];
					var dishesId = dish.id;
					var dishesName = dish.name;
					var dishesDiscript = dish.description;
					var dishesImg = dish.img;
					var dishesTxt = dish.txt;
					var recommend = dish.recommend;
					var dishesPrice = dish.price;
	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				<li><span class="navbar-brand">点单界面：当前桌号<span id="tableresult">【${tableId}】</span></span></li>
