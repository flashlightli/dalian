	...
	function getUserList() {
		...
		$.ajax({
			...
			success: function (result) {
				...
				sessionNum.innerHTML = result.onlineNum;
				kitchenNum.innerHTML = result.onlineKitchenNum;
				var table = document.getElementById("orderTable");
				table.innerHTML = "";
				for ( var i = 0; i < result.onlineKitchenNum; i++) {
					var user = result.onlineKitchens[i];
