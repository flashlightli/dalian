					...
					<div class="row" style="padding-top: 0px">
							...
							<div>
								...
								<form class="form-horizontal" role="form"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="dishesName"
												value="${DISHES_INFO.name }" size="20"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="dishesDiscript"
												value="${DISHES_INFO.description }" name="dishesDiscript"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea rows="8" class="form-control" name="dishesTxt">${DISHES_INFO.txt }</textarea>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="dishesPrice"
												...
												value="${DISHES_INFO.price }" onblur="checkprice()">
										</div>
									...
									<input type="hidden" value="${DISHES_INFO.id }" id="dishesId"
						...
						<div style="width: 25%;display: inline-block;vertical-align: top;">
							...
							<div style="text-align: center;">
								<img src="img/dishes/${DISHES_INFO.img }" id="face"
